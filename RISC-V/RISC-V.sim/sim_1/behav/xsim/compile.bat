...
REM
REM Generated by Vivado on Wed Jun 24 21:47:07 -0400 2026
...
echo "xvlog --incr --relax -L uvm -prj ID_top_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj ID_top_tb_vlog.prj -log xvlog.log
